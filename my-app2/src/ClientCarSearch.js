...
class ClientCarSearch extends Component {
  ...
  componentDidMount() {
    ...
    let fuelRequest = "https://localhost:8085/car/fuelTypes";
    let carClassRequest = "https://localhost:8085/car/classes";
    let transmissionRequest = "https://localhost:8085/car/transmissionTypes";
    let locationRequest = "https://localhost:8085/car/locations";
                  ...
                  <div className="booking-form">
                    ...
                    <form>
                      ...
                      <div className="mb-2">
                        ...
                        <Button disabled={!this.state.startDate || !this.state.endDate || !this.state.pickupLocationKey}
  ...
  async handleSubmit() {
    ...
    const formData = {
      manufacturerId: this.state.manufacturerKey,
      ...
      minPrice: this.state.priceFrom,
      maxPrice: this.state.priceTo,
      collisionWarranty: this.state.collisionWarranty,
      maxMileage: this.state.mileage,
      minMileage: null,
      plannedMileage: this.state.expectedMileage,
      minChildSeats: this.state.childSeats,
    ...
    let sd = this.state.startDate.toISOString();
    let ed = this.state.endDate.toISOString()

    sessionStorage.setItem('searchData',searchData);
    sessionStorage.setItem('startDate',sd);
    sessionStorage.setItem('endDate',ed);
    sessionStorage.setItem('collisionWarranty', this.state.collisionWarranty);
    this.props.history.push("/searchresults/");

  };
}
export default ClientCarSearch;
