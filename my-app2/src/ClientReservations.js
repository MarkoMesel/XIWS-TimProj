...
class ClientReservations extends Component {
    ...
    handleCancel = (event) => {
        let cancelLink = 'https://localhost:8085/schedule/bundle/' + event.target.value + '/cancel';
        let body = null;
                    ...
                    {bundle.cars.map((car) =>
                        <div key={car.carId}>
                            ...
                            <div className="column25">
                                <img alt={t1} className="photo5" src={'https://localhost:8085/car/image/' + car.images[0]}></img>
                            </div>
                        </div>
