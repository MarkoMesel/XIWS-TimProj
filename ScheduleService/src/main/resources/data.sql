...
--PRICE-----------------------------------------------
INSERT INTO PRICE (ID, PRICE_LIST_ID, START_DATE, END_DATE, PRICE, PUBLISHER_ID, PUBLISHER_TYPE_ID)
VALUES (1, 2, PARSEDATETIME('1 Jan 2020 10:30:00','dd MMM yyyy HH:mm:ss','en'),PARSEDATETIME('31 Jan 2020 12:00:00','dd MMM yyyy HH:mm:ss','en'), 20, 2, 2);

INSERT INTO PRICE (ID, PRICE_LIST_ID, START_DATE, END_DATE, PRICE, PUBLISHER_ID, PUBLISHER_TYPE_ID)
VALUES (2, 2, PARSEDATETIME('1 Feb 2020 04:00:00','dd MMM yyyy HH:mm:ss','en'),PARSEDATETIME('29 Jan 2020 09:00:00','dd MMM yyyy HH:mm:ss','en'), 30, 2, 2);

INSERT INTO PRICE (ID, PRICE_LIST_ID, START_DATE, END_DATE, PRICE, PUBLISHER_ID, PUBLISHER_TYPE_ID)
VALUES (3, 2, PARSEDATETIME('1 Mar 2020 17:00:00','dd MMM yyyy HH:mm:ss','en'), PARSEDATETIME('31 Mar 2020 00:50:00','dd MMM yyyy HH:mm:ss','en'), 40, 2, 2);
