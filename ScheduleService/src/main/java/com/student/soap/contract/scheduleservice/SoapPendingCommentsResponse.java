 ...
 *       &lt;sequence&gt;
 *         &lt;element name="pendingComment" type="{http://www.student.com/scheduleservice/soap/contract}Comment" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends StatusType
{
    ...
    protected List<Comment> pendingComment;
     ...
     * 
     */
    public List<Comment> getPendingComment() {
        if (pendingComment == null) {
            pendingComment = new ArrayList<Comment>();
        }
