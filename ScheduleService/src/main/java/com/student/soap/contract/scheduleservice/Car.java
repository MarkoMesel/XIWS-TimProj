 ...
 *         &lt;element name="warrantyIncluded" type="{http://www.w3.org/2001/XMLSchema}boolean"/&gt;
 *         &lt;element name="totalPrice" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
 *         &lt;element name="extraCharges" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
public class Car {
    ...
    protected Boolean warrantyIncluded;
    @XmlElement(required = true, type = Integer.class, nillable = true)
    protected Integer totalPrice;
    @XmlElement(required = true, type = Integer.class, nillable = true)
    protected Integer extraCharges;
    @XmlElement(required = true, type = Integer.class, nillable = true)
    ...
    /**
     * Gets the value of the warrantyIncluded property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the warrantyIncluded property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setWarrantyIncluded(Boolean value) {
        this.warrantyIncluded = value;
    }
     ...
     *     
     */
    public void setExtraCharges(Integer value) {
