...
class AdminRateManage extends Component {
    ...
    handleApprove = (event) =>{
        let approveLink = 'https://localhost:8080/schedule/comments/' + event.target.value + '/approve';
    ...
    handleDecline = (event) =>{
        ...
        let rejectLink = 'https://localhost:8080/schedule/comments/' + event.target.value + '/reject'
        axios.post(
