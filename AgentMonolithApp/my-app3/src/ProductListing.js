...
class ProductListing extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("https://localhost:8080/car/getCar" + carID.carID)
            .then(res => {
                const car = res.data;
                this.setState({ car });
            ...
            axios.get("http://localhost:8080/schedule/car/" + carID.carID + "/comments")
            .then(res => {
        ...
        const renderImages = images.map((im) => {
            return <CarouselItem key={im}>
                <img
                    ...
                    src={'http://localhost:8080/car/getImage/' + im}
                    alt="First slide" />
            </CarouselItem>
