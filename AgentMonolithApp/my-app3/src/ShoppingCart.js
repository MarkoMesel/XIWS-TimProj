...
class ShoppingCart extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(
            'https://localhost:8080/schedule/cart', axiosConfig)
            .then(response => {
    ...
    handleRemoveFromCart = (event) => {
        ...
        let deleteLink = 'https://localhost:8080/schedule/cart/' + event.target.value;
    ...
    handleBundle = (event) => {
        ...
        axios.post('https://localhost:8080/schedule/cart/bundle', bundleData, axiosConfig)
            .then(response => {
    ...
    handleUnbundle = (event) => {
        ...
        axios.post('https://localhost:8080/schedule/cart/unbundle', unbundleData, axiosConfig)
            .then(response => {
    ...
    handleSubmitCart(){
        let submitData = null;
        axios.post('https://localhost:8080/schedule/reserve', submitData, axiosConfig)
        .then(response => {
                ...
                <Card>
                    {bundle.cars.map((car) =>
                        <div key={car.carId}>
                            ...
                            <img alt={'https://tipkingdom.com/wp-content/uploads/2018/05/windows_bug6-100581894-primary-idge.jpg'} className="photo5" src={'https://localhost:8080/car/image/' + car.images[0]}></img>
                            </div>
                        </div>
