...
class SearchResults extends Component {
    ...
    componentDidMount() {
        ...
        axios.post(
            'https://localhost:8080/car/search',
    ...
    handleAddToCartPressed = (event) => {
        ...
        axios.post('https://localhost:8080/schedule/cart', 
        ...
        const renderCars = currentCars.map((car) => {
            return <div className="colummn" key={car.id}>
                <div className="column">
                    <img alt={BackupPhoto} className="photo" src={'https://localhost:8080/car/image/' + car.images[0]}></img>
                </div>
