...
class AdminDbManage extends Component {
    ...
    componentDidMount() {
        ...
        let getAllCarClasses = 'https://localhost:8080/car/classes';
        let getAllCarManufacturers = 'https://localhost:8080/car/manufacturers';
        let getAllLocations = 'https://localhost:8080/car/locations';
        let getAllModels = 'https://localhost:8080/car/models';
        let getAllFuelTypes = 'https://localhost:8080/car/fuelTypes';
        let getAllTransmissionTypes = 'https://localhost:8080/car/transmissionTypes';
    ...
    deleteCarClass() {
        let link = 'https://localhost:8080/car/classes/'+ this.state.carClassKey;
    ...
    deleteCarManufacturers() {
        ...
        if (!(listOfManId.includes(manKey))) {
            ...
            let link = 'https://localhost:8080/car/manufacturers/' + manKey;
            axios.delete(link, axiosConfig)
            .then(response => {
    ...
    deleteLocation() {
        let link = 'https://localhost:8080/car/locations/'+ this.state.locationKey;
    ...
    deleteModel() {
        let link = 'https://localhost:8080/car/models/'+ this.state.modelKey;
    ...
    deleteFuelType() {
        let link = 'https://localhost:8080/car/fuelTypes/'+ this.state.fuelTypeKey;
    ...
    deleteTransmissionType() {
        let link = 'https://localhost:8080/car/transmissionTypes/'+ this.state.transmissionTypeKey;
    ...
    handleAddCarClass = (event) => {
        ...
        if (!(listOfCarClassNames.includes(textCheck))) {
            axios.post(
                'https://localhost:8080/car/classes', carClassText, axiosConfig)
                .then(response => {
    ...
    handleAddCarManufacturer = (event) => {
        ...
        if (!listOfNames.includes(textCheck)) {
            axios.post(
                'https://localhost:8080/car/manufacturers', text, axiosConfig)
                .then(response => {
    ...
    handleAddLocation = (event) => {
        ...
        if (!listOfNames.includes(textCheck)) {
            axios.post(
                'https://localhost:8080/car/locations', text, axiosConfig)
                .then(response => {
    ...
    handleAddFuelType = (event) => {
        ...
        if (!listOfNames.includes(textCheck)) {
            axios.post(
                'https://localhost:8080/car/fuelTypes', text, axiosConfig)
                .then(response => {
    ...
    handleAddTransmissionType = (event) => {
        ...
        if (!listOfNames.includes(textCheck)) {
            axios.post(
                'https://localhost:8080/car/transmissionTypes', text, axiosConfig)
                .then(response => {
    ...
    handleAddModel = (event) => {
        ...
        if (!listOfNames.includes(textCheck)) {
            axios.post(
                'https://localhost:8080/car/models', text, axiosConfig)
                .then(response => {
