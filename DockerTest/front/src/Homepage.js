...
class Homepage extends Component {
  ...
  componentDidMount() {
    ...
    let manufacturerRequest = "http://localhost:8082/car/manufacturers";
    let modelRequest = "http://localhost:8082/car/manufacturer/1/models";
    let fuelRequest = "http://localhost:8082/car/fuelTypes";
    let carClassRequest = "http://localhost:8082/car/classes";
    let transmissionRequest = "http://localhost:8082/car/transmissionTypes";
    let locationRequest = "http://localhost:8084/schedule/locations";
