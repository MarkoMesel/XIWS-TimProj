...
--CAR
--Honda
INSERT INTO CAR ( ID, ACTIVE, PUBLISHER_ID, PUBLISHER_TYPE_ID, CHILD_SEATS, MILEAGE, CARCLASS_ID, MODEL_ID, FUELTYPE_ID, TRANSMISSIONTYPE_ID) 
VALUES (1, TRUE, 1, 2, 1, 225000, 3, 1, 1, 1);
INSERT INTO CAR ( ID, ACTIVE, PUBLISHER_ID, PUBLISHER_TYPE_ID, CHILD_SEATS, MILEAGE, CARCLASS_ID, MODEL_ID, FUELTYPE_ID, TRANSMISSIONTYPE_ID) 
VALUES (2, TRUE, 1, 2, 0, 110000, 1, 1, 2, 2);
INSERT INTO CAR ( ID, ACTIVE, PUBLISHER_ID, PUBLISHER_TYPE_ID, CHILD_SEATS, MILEAGE, CARCLASS_ID, MODEL_ID, FUELTYPE_ID, TRANSMISSIONTYPE_ID) 
VALUES (3, TRUE, 1, 2, 1, 219000, 2, 2, 3, 1);
INSERT INTO CAR ( ID, ACTIVE, PUBLISHER_ID, PUBLISHER_TYPE_ID, CHILD_SEATS, MILEAGE, CARCLASS_ID, MODEL_ID, FUELTYPE_ID, TRANSMISSIONTYPE_ID) 
VALUES (4, TRUE, 1, 2, 0, 110700, 1, 2, 1, 3);
